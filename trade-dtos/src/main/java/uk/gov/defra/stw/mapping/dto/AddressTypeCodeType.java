...
public class AddressTypeCodeType implements Serializable
{
    ...
    private final static long serialVersionUID = 7395193959776311394L;
    ...
    public AddressTypeCodeType withListAgencyID(String listAgencyID) {
        this.listAgencyID = listAgencyID;
        return this;
    }
    ...
    public AddressTypeCodeType withListID(String listID) {
        this.listID = listID;
        return this;
    }
    ...
    public AddressTypeCodeType withListVersionID(String listVersionID) {
        this.listVersionID = listVersionID;
        return this;
    }
    ...
    public AddressTypeCodeType withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public AddressTypeCodeType withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(AddressTypeCodeType.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AddressTypeCodeType) == false) {
            return false;
        }
        AddressTypeCodeType rhs = ((AddressTypeCodeType) other);
