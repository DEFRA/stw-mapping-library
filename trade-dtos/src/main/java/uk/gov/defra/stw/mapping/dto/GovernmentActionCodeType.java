...
public class GovernmentActionCodeType implements Serializable
{
    ...
    private final static long serialVersionUID = -6101960912317771841L;
    ...
    public GovernmentActionCodeType withListAgencyID(String listAgencyID) {
        this.listAgencyID = listAgencyID;
        return this;
    }
    ...
    public GovernmentActionCodeType withListID(String listID) {
        this.listID = listID;
        return this;
    }
    ...
    public GovernmentActionCodeType withListVersionID(String listVersionID) {
        this.listVersionID = listVersionID;
        return this;
    }
    ...
    public GovernmentActionCodeType withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public GovernmentActionCodeType withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(GovernmentActionCodeType.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GovernmentActionCodeType) == false) {
            return false;
        }
        GovernmentActionCodeType rhs = ((GovernmentActionCodeType) other);
