...
public class TemperatureTypeCodeType implements Serializable
{
    ...
    private final static long serialVersionUID = 7729663992755020878L;

    public TemperatureTypeCodeType() {
    }
    ...
    public TemperatureTypeCodeType withListAgencyID(String listAgencyID) {
        this.listAgencyID = listAgencyID;
        return this;
    }
    ...
    public TemperatureTypeCodeType withListID(String listID) {
        this.listID = listID;
        return this;
    }
    ...
    public TemperatureTypeCodeType withListVersionID(String listVersionID) {
        this.listVersionID = listVersionID;
        return this;
    }
    ...
    public TemperatureTypeCodeType withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public TemperatureTypeCodeType withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(TemperatureTypeCodeType.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TemperatureTypeCodeType) == false) {
            return false;
        }
        TemperatureTypeCodeType rhs = ((TemperatureTypeCodeType) other);
