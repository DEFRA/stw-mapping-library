...
public class PackageTypeCodeType implements Serializable {
    private String listAgencyID;
    private String listID;
    private String listVersionID;
    private String name;
    private String value;
    private final static long serialVersionUID = -5272026874933108576L;
    ...
    public PackageTypeCodeType withListAgencyID(String listAgencyID) {
        this.listAgencyID = listAgencyID;
        return this;
    }
    ...
    public PackageTypeCodeType withListID(String listID) {
        this.listID = listID;
        return this;
    }
    ...
    public PackageTypeCodeType withListVersionID(String listVersionID) {
        this.listVersionID = listVersionID;
        return this;
    }
    ...
    public PackageTypeCodeType withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public PackageTypeCodeType withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PackageTypeCodeType.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PackageTypeCodeType) == false) {
            return false;
        }
        PackageTypeCodeType rhs = ((PackageTypeCodeType) other);
