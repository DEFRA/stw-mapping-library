...
public class DocumentCodeType implements Serializable
{
    ...
    private final static long serialVersionUID = -7775113012852067274L;
    ...
    public DocumentCodeType withListAgencyID(String listAgencyID) {
        this.listAgencyID = listAgencyID;
        return this;
    }
    ...
    public DocumentCodeType withListID(String listID) {
        this.listID = listID;
        return this;
    }
    ...
    public DocumentCodeType withListURI(String listURI) {
        this.listURI = listURI;
        return this;
    }
    ...
    public DocumentCodeType withListVersionID(String listVersionID) {
        this.listVersionID = listVersionID;
        return this;
    }
    ...
    public DocumentCodeType withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public DocumentCodeType withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(DocumentCodeType.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DocumentCodeType) == false) {
            return false;
        }
        DocumentCodeType rhs = ((DocumentCodeType) other);
