...
public class ProcessTypeCodeType implements Serializable
{
    ...
    private final static long serialVersionUID = 7646023267489458858L;
    ...
    public ProcessTypeCodeType withListAgencyID(String listAgencyID) {
        this.listAgencyID = listAgencyID;
        return this;
    }
    ...
    public ProcessTypeCodeType withListID(String listID) {
        this.listID = listID;
        return this;
    }
    ...
    public ProcessTypeCodeType withListVersionID(String listVersionID) {
        this.listVersionID = listVersionID;
        return this;
    }
    ...
    public ProcessTypeCodeType withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ProcessTypeCodeType withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ProcessTypeCodeType.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ProcessTypeCodeType) == false) {
            return false;
        }
        ProcessTypeCodeType rhs = ((ProcessTypeCodeType) other);
