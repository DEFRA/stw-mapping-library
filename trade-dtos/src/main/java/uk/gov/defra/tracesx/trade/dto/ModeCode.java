...
public class ModeCode implements Serializable
{
    ...
    private final static long serialVersionUID = -715656387148231696L;
    ...
    public ModeCode withListAgencyID(String listAgencyID) {
        this.listAgencyID = listAgencyID;
        return this;
    }
    ...
    public ModeCode withListID(String listID) {
        this.listID = listID;
        return this;
    }
    ...
    public ModeCode withListVersionID(String listVersionID) {
        this.listVersionID = listVersionID;
        return this;
    }
    ...
    public ModeCode withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ModeCode withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(ModeCode.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ModeCode) == false) {
            return false;
        }
        ModeCode rhs = ((ModeCode) other);
