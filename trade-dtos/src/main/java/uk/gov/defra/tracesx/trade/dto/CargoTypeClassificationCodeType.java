...
public class CargoTypeClassificationCodeType implements Serializable
{
    ...
    private final static long serialVersionUID = 543238631639267286L;
    ...
    public CargoTypeClassificationCodeType withListAgencyID(String listAgencyID) {
        this.listAgencyID = listAgencyID;
        return this;
    }
    ...
    public CargoTypeClassificationCodeType withListID(String listID) {
        this.listID = listID;
        return this;
    }
    ...
    public CargoTypeClassificationCodeType withListVersionID(String listVersionID) {
        this.listVersionID = listVersionID;
        return this;
    }
    ...
    public CargoTypeClassificationCodeType withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CargoTypeClassificationCodeType withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CargoTypeClassificationCodeType.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CargoTypeClassificationCodeType) == false) {
            return false;
        }
        CargoTypeClassificationCodeType rhs = ((CargoTypeClassificationCodeType) other);
