package uk.gov.defra.tracesx.integration.enotification;
...
@ComponentScan(basePackages = {"uk.gov.defra.tracesx.enotification", "uk.gov.defra.tracesx.common"})
  ...
  void map_ReturnsChedpNotification_WhenCompleteEhcSpsCertificate() throws Exception {
    ...
    SpsCertificate spsCertificate =
        JsonDeserializer.get(
            SpsCertificate.class, "enotification/chedp/chedp_ehc_complete.json", objectMapper);
