...
import uk.gov.defra.stw.mapping.toipaffs.common.common.utils.VeterinaryInformationFieldMapper;
...
class ChedppVeterinaryInformationMapperTest {
  ...
  private List<SpsReferencedDocumentType> setUpSpsReferenceDocumentTypes() throws Exception{
    return JsonDeserializer.get(
        ...
        "common/chedpp/partone/veterinaryinformation/chedpp_ehc_veterinaryinformation_complete.json",
        objectMapper);
  }
}
