...
import uk.gov.defra.stw.mapping.toipaffs.enotification.chedpp.commodities.ChedppCommodityComplementMapper;
import uk.gov.defra.stw.mapping.toipaffs.enotification.chedpp.commodities.ChedppComplementParameterSetMapper;
...
class ChedppCommoditiesMapperTest {
  ...
  void setup() throws JsonProcessingException {
    ...
    commodityComplements = JsonDeserializer.get(objectMapper.getTypeFactory().constructCollectionType(List.class, CommodityComplement.class),
        "enotification/chedpp/partone/commodities/chedpp_ipaffs_commodityComplement_complete.json", objectMapper);
    complementParameterSets = JsonDeserializer.get(objectMapper.getTypeFactory().constructCollectionType(List.class, ComplementParameterSet.class),
        "enotification/chedpp/partone/commodities/chedpp_ipaffs_complementParameterSet_complete.json", objectMapper);
  }
  ...
  void map_ReturnsCommodities_WhenComplete() throws NotificationMapperException, JsonProcessingException {
    ...
    String expectedCommodities = ResourceUtils
        .readFileToString("classpath:enotification/chedpp/partone/commodities/chedpp_ipaffs_commodities_complete.json");
