package uk.gov.defra.stw.mapping.toipaffs.integration.cloning;
...
@ComponentScan(basePackages = {"uk.gov.defra.stw.mapping.toipaffs.cloning", "uk.gov.defra.stw.mapping.toipaffs.common"})
