...
@Component
public class ChedpNotificationMapper implements Mapper<SpsCertificate, Notification> {
  ...
  @Autowired
  public ChedpNotificationMapper(ChedpPartOneMapper chedpPartOneMapper) {
