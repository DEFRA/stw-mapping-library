...
import static uk.gov.defra.tracesx.enumeration.DestinationType.CUSTOMS_WAREHOUSE;
import static uk.gov.defra.tracesx.enumeration.DestinationType.FREE_ZONE;
import static uk.gov.defra.tracesx.enumeration.DestinationType.SHIP;
import static uk.gov.defra.tracesx.enumeration.Purpose.DIRECT_TRANSIT;
import static uk.gov.defra.tracesx.enumeration.Purpose.INTERNAL_MARKET;
import static uk.gov.defra.tracesx.enumeration.Purpose.NON_CONFORMING_GOODS;
import static uk.gov.defra.tracesx.enumeration.Purpose.RE_ENTRY;
import static uk.gov.defra.tracesx.enumeration.Purpose.TRANSHIPMENT;
import static uk.gov.defra.tracesx.enumeration.SubjectCode.NON_CONFORMING_GOODS_DESTINATION_TYPE;
